...
| MOT-006 | Undo/Redo | حداقل ۵۰ command بدون corruption | PC-030 | `qa/tests/drawing-history.test.mjs`: 60 command، 50 undo+50 redo، deep-copy، redo invalidation و cap=100 پاس؛ E2E toolbar pending | PARTIAL |
