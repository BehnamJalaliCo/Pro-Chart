...
- `Pro-Chart/.codex-backups/` — بکاپِ یک‌بارهٔ ۱۴ ژوئیهٔ کدکس. به خواستِ مالک
  کاملاً حذف شد: از گیت، از سرور، و از آینهٔ گوگل‌درایو. دیگر وجود ندارد.
- `app/avatar_work/` — پروژهٔ آواتار/لب‌سینک (۵۸۲ مگابایت). آن هم به خواستِ مالک
  از هر سه جا حذف شد.
