...
function Watermark() {
  ...
  const svg = `<svg xmlns='http://www.w3.org/2000/svg' width='340' height='150'><text x='0' y='80' transform='rotate(-24 0 80)' fill='rgba(150,160,180,0.10)' font-size='15' font-family='Vazirmatn,sans-serif'>${tag}</text></svg>`;
