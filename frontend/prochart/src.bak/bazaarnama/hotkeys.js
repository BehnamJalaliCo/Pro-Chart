...
export const SHORTCUTS = [
  ...
  { id: 'ruler',    group: 'ابزارها', combo: 'Alt+M',   label: 'خط‌کش (اندازه‌گیری)',  match: (e) => altOnly(e) && k(e) === 'm' },
  { id: 'measureInfo', group: 'ابزارها', combo: 'Shift+درگ', label: 'اندازه‌گیریِ سریع (کشیدن روی چارت)', match: () => false },
  ...
  { id: 'gotoDate',   group: 'ناوبری', combo: 'Alt+G', label: 'برو به تاریخ', match: (e) => altOnly(e) && k(e) === 'g' },
  ...
  { id: 'symbolNext',  group: 'نما', combo: ']', label: 'نمادِ بعدی (واچ‌لیست)', match: (e) => noMods(e) && (e.key === ']' || k(e) === 'bracketright') },
  { id: 'symbolPrev',  group: 'نما', combo: '[', label: 'نمادِ قبلی (واچ‌لیست)', match: (e) => noMods(e) && (e.key === '[' || k(e) === 'bracketleft') },
  { id: 'symBack',     group: 'نما', combo: 'Alt+←', label: 'نمادِ قبلی (تاریخچه)', match: (e) => altOnly(e) && k(e) === 'arrowleft' },
  { id: 'symFwd',      group: 'نما', combo: 'Alt+→', label: 'نمادِ بعدی (تاریخچه)', match: (e) => altOnly(e) && k(e) === 'arrowright' },
  ...
  // ── تحلیل روی چارت ──
  { id: 'toggleVolume',   group: 'تحلیل', combo: 'Shift+V', label: 'هیستوگرامِ حجم', match: (e) => shiftOnly(e) && k(e) === 'v' },
  { id: 'togglePatterns', group: 'تحلیل', combo: 'Shift+P', label: 'الگوهای کندل‌استیک', match: (e) => shiftOnly(e) && k(e) === 'p' },
  { id: 'toggleDiv',      group: 'تحلیل', combo: 'Shift+D', label: 'واگراییِ RSI', match: (e) => shiftOnly(e) && k(e) === 'd' },
  { id: 'toggleVP',       group: 'تحلیل', combo: 'Shift+R', label: 'پروفایلِ حجم', match: (e) => shiftOnly(e) && k(e) === 'r' },
  { id: 'togglePD',       group: 'تحلیل', combo: 'Shift+K', label: 'خطوطِ روزِ قبل (PDH/PDL/PDC)', match: (e) => shiftOnly(e) && k(e) === 'k' },
  { id: 'toggleHarm',     group: 'تحلیل', combo: 'Shift+H', label: 'الگوهای هارمونیک', match: (e) => shiftOnly(e) && k(e) === 'h' },
  { id: 'toggleGaps',     group: 'تحلیل', combo: 'Shift+G', label: 'نشانگرِ گپِ قیمت', match: (e) => shiftOnly(e) && k(e) === 'g' },
