    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-2xl bg-brand-blue/20 flex items-center justify-center text-brand-blue text-2xl font-bold mx-auto mb-4">
            FX
          </div>
          <h1 className="text-2xl font-bold text-text-primary mb-1">پنل مدیریت</h1>
          <p className="text-sm text-text-muted">سیگنال فارکس - ورود به پنل</p>
        </div>
