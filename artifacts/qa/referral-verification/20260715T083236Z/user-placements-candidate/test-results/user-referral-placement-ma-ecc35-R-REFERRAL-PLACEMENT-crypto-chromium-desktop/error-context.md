...
- Name: user-referral-placement-matrix.spec.mjs >> USER-REFERRAL-PLACEMENT: / crypto
- Location: tests/user-referral-placement-matrix.spec.mjs:125:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://user.pro-chart.com:18081/
Call log:
  - navigating to "http://user.pro-chart.com:18081/", waiting until "domcontentloaded"
