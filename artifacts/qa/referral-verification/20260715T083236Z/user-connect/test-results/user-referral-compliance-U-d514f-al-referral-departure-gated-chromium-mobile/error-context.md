...
- Name: user-referral-compliance.spec.mjs >> USER-REFERRAL: real /connect keeps OneRoyal referral departure gated
    ...
    - generic [ref=e30]:
      ...
      - generic [ref=e43]:
        - generic [ref=e44]:
          - img [ref=e46]
          - generic [ref=e50]:
            - generic [ref=e51]: معرفی OneRoyal
            - generic [ref=e52]: OneRoyal فقط در سطح معرفی است؛ اتصال حساب و معاملهٔ مستقیم فعال نیست.
        - region "لینک معرفی OneRoyal" [ref=e53]:
          - paragraph [ref=e54]:
          ...
          - button "لینک معرفی — ورود به وب‌سایت OneRoyal" [ref=e61] [cursor=pointer]
      - generic [ref=e62]:
        - generic [ref=e63]:
          - img [ref=e65]
          - generic [ref=e68]:
            - generic [ref=e69]: OneRoyal — فقط معرفی
            - generic [ref=e70]: اتصال MT5، دریافت credential و معامله مستقیم غیرفعال است.
        - paragraph [ref=e71]: ادامهٔ ثبت‌نام و ارائهٔ خدمت تابع شرایط OneRoyal و محل اقامت شماست؛ Pro Chart حساب یا سفارش OneRoyal را دریافت نمی‌کند.
  - navigation [ref=e72]:
    - link "داشبورد" [ref=e73] [cursor=pointer]:
      - /url: /
      - img [ref=e74]
      - text: داشبورد
    - link "بازار" [ref=e79] [cursor=pointer]:
      - /url: /market
      - img [ref=e80]
      - text: بازار
    - link "سیگنال" [ref=e83] [cursor=pointer]:
      - /url: /signals
      - img [ref=e84]
      - text: سیگنال
    - link "معاملات" [ref=e86] [cursor=pointer]:
      - /url: /trade
      - img [ref=e87]
      - text: معاملات
    - link "اتصال" [ref=e90] [cursor=pointer]:
      - /url: /connect
      - img [ref=e91]
      - text: اتصال
    - link "اشتراک" [ref=e94] [cursor=pointer]:
      - /url: /subscription
      - img [ref=e95]
      - text: اشتراک
    - link "پروفایل" [ref=e97] [cursor=pointer]:
      - /url: /profile
      - img [ref=e98]
      - text: پروفایل
```
