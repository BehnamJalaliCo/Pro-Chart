...
آخرین به‌روزرسانی: `2026-07-15T04:31:00Z`
...
| Status / Gate | `IN_PROGRESS=33`، `NOT_STARTED=129`؛ `FAIL=7`، `PARTIAL=30`، `PASS_BASELINE=1`، `NOT_ASSESSED=124` |
...
| وضعیت کلی | `IN_PROGRESS`؛ referral-only و runtime supply در production هستند، اما Gateهای Python clean-suite، Secret history/rotation، امضای artifact، دسترس‌پذیری کامل و سه Clean run باز یا FAIL هستند |
...
- Main edge: image=`sha256:20e2ad31c1280f44850530a7ac12456f4817da8f163fdd230defe0436f7fa3ec`؛ User Portal=`sha256:6a5c2512392cdb8257c804a0ca116c4fed9ce4186fd9a6e2685c313d1dcf6216`؛ Panel=`sha256:8b6231de18db8810b8d83e02b3db83960cb9b5f1b33de0549961360073535ea2`.
...
| Python clean suite | `FAIL` | ۳۴۱ JUnit case: ۲۵۵ pass شامل ۳۹ subtest، ۵۴ fail، ۳۲ error، ۰ skip؛ console summary=216 pass +39 subtest؛ focused Referral/Bot=۱۳/۱۳ و `pip check` پاس |
