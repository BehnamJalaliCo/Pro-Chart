...
_HOME_FAQ = [
    ("بازارنما چیست؟", "بازارنما یک پلتفرم حرفه‌ای چارت آنلاین و ترید بازارهای مالی به‌سبک تریدینگ‌ویو و کاملاً فارسی است؛ با نمودار زنده، بیش از ۵۰ اندیکاتور، NamaScript، واچ‌لیست، هشدار قیمت، سیگنال هوش مصنوعی، ترید مستقیم ارز دیجیتال از طریق LBank و مسیر معرفی OneRoyal."),
    ("آیا می‌توانم از روی چارت ترید واقعی بزنم؟", "ترید مستقیم فقط برای ارز دیجیتال و با اتصال حساب LBank ارائه می‌شود. OneRoyal صرفاً یک مسیر معرفی (referral-only) است؛ بازارنما اطلاعات ورود متاتریدر را دریافت نمی‌کند و سفارش OneRoyal/MT5 ثبت نمی‌کند."),
...
def _home_doc(latest: list[Article]) -> Response:
    ...
    desc = ("بازارنما، پلتفرم چارت زنده و تریدینگ‌ویو فارسی؛ نمودار لحظه‌ای ارز دیجیتال، فارکس و طلا "
            "با +۵۰ اندیکاتور، واچ‌لیست، هشدار قیمت، سیگنال هوش مصنوعی و ترید مستقیم ارز دیجیتال از طریق LBank؛ OneRoyal فقط مسیر معرفی است.")
    org_desc = ("بازارنما پلتفرم حرفه‌ای چارت آنلاین و ترید بازارهای مالی به‌سبک تریدینگ‌ویو و کاملاً فارسی است؛ "
                "چارت زنده ارز دیجیتال، فارکس و طلا، اندیکاتور، واچ‌لیست، هشدار قیمت، سیگنال هوش مصنوعی و ترید مستقیم ارز دیجیتال از طریق LBank؛ OneRoyal referral-only است.")
