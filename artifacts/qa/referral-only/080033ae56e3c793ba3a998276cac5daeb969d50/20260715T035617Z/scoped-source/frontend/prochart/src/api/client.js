...
export const api = {
  ...
  bnDisconnectLbank: () => client.delete('/academy/bn/connect/lbank'),
  ...
  bnAds: () => client.get('/academy/bn/ads'),
  bnAdminSetAds: (slot, logo, text, link, active) => client.post('/academy/bn/admin/ads', { slot, logo, text, link, active }, { headers: _ah() }),
