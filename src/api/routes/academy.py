    ...
    return {
        ...
        "tiers": [
            {"key": "free", "name": "رایگان", "price_monthly": 0,
             "tagline": "شروعِ رایگان",
             "perks": ["ترمینالِ چارت + واچ‌لیستِ زنده", "هشدارهای قیمت", "اخبار و تقویمِ اقتصادی"]},
            {"key": "vip", "name": "VIP", "price_monthly": settings.ACADEMY_PRICE_VIP_MONTHLY,
             "tagline": "معامله‌گرِ فعال",
             "perks": ["همه‌چیزِ رایگان", "سیگنال‌های هوشِ مصنوعی — ۲ در روز",
                       "اسکریپت‌نویسیِ اندیکاتور/استراتژی", "لایوت‌های نامحدودِ چارت"]},
